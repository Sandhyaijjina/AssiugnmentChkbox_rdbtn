	...
	public static WebDriver startBrowser(String browser) {
		...
		if (browser.equalsIgnoreCase("Chrome") || browser.equalsIgnoreCase("GC")
			...
			System.setProperty("webdriver.chrome.driver",
					"C:\\SeleniumProject\\SeleniumWebDriver launchBrowser\\Chrome Browser Drivers\\chromedriver.exe");
			driver = new ChromeDriver();
		} else if (browser.equalsIgnoreCase("Edge") || browser.equalsIgnoreCase("EG")
				|| browser.equalsIgnoreCase("Microsoft Edge")) {
			System.setProperty("webdriver.edge.driver",
					"C:\\SeleniumProject\\SeleniumWebDriver launchBrowser\\EdgeBrowser\\msedgedriver.exe");
